...
class CameraCtrl(LatentVisualDiffusion):
    def __init__(self,
    ...
    trace_scale_factor=1.0, cond_frame_index=None, **kwargs):
        ...
        z, c, xrec, xc, fs, cond_frame_index, depth_scale, cond_x, x, camera_data, video_path = self.get_batch_input(
        ...
        if sample:
            ...
            if "preview" in kwargs:
                ...
                preview_path = f"/tmp/cami2v_preview_{uuid4().fields[0]:x}.mp4"
