...
#             x = x + self.pluker_projection(self.norm_pluker1(x) + self.norm_pluker2(pluker_embedding_features))
#
#         if hasattr(self, 'epipolar'):
#             x = x + self.epipolar(
#                 rearrange(self.norm_epipolar(x), '(b h w) f c -> b f c h w', h=camera_condition['h'], w=camera_condition['w']),
#                 camera_condition["sample_locs_dict"],
#             ) # (b h w) f c
#         # else:
#         #     print('no epipolar')
#
