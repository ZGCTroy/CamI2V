...
class DDIMSampler(object):
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None,
                      unconditional_conditioning=None,
                      uc_type=None, ucfg_text=1.0, ucfg_img=1.0, ucfg_camera_condition=1.0, mask=None,x0=None,guidance_rescale=0.0, **kwargs):
        ...
        if ucfg_text != 0.0:
            e_t_img_camera_text =  self.model.apply_model(x, t, c, **kwargs)
            e_t_img_camera = self.model.apply_model(x, t, c, **kwargs)
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            ...
            # text cfg
            model_output = e_t_uncond + ucfg_img * (e_t_uncond_img - e_t_uncond) + ucfg_text * (e_t_cond - e_t_uncond_img)
            # model_output = ucfg_text * e_t_cond + (ucfg_img - ucfg_text) * e_t_uncond_img + (1-ucfg_img) * e_t_uncond
